...
struct Camera{
     ...
     */
    Camera():_eyePoint(vec3(0,0,-10)),_viewDir(vec3(0,0,1)),_upDir(vec3(0,1,0)), _field_of_view(90){}
    explicit Camera(const vec3 _eyePoint):_eyePoint(_eyePoint),_viewDir(vec3(0,0,1)),_upDir(vec3(0,1,0)), _field_of_view(90){}
    Camera(const vec3 _eyePoint, const vec3 _viewDir):_eyePoint(_eyePoint),_viewDir(_viewDir),_upDir(vec3(0,1,0)), _field_of_view(90){}
    Camera(const vec3 _eyePoint, const vec3 _viewDir, const vec3 _upDir):_eyePoint(_eyePoint),_viewDir(_viewDir),_upDir(_upDir), _field_of_view(90){}
